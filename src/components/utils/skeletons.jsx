  ...
  return (
    <div
      ...
      <div className='flex flex-col md:flex-row'>
        <div className='h-40 mb-4 rounded-md bg-white md:w-1/3 pr-6'></div>
        <div className='md:w-2/3 px-2'>
          <h2 className='h-14 w-3/4 rounded-md bg-white text-sm font-medium'></h2>
          <p className='mt-2 h-6 w-1/2 rounded-md bg-white text-sm font-medium'></p>
          <p className='mt-2 h-6 w-1/2 rounded-md bg-white text-sm font-medium'></p>
          <p className='mt-2 h-6 w-1/2 rounded-md bg-white text-sm font-medium'></p>
        </div>
      </div>
      <div className='mt-4'>
        <p className='mt-2 h-80 w-full rounded-md bg-white text-sm font-medium' />
      </div>
    </div>
  );
}
